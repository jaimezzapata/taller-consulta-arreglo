...
playlist.push({ titulo: "Imagine", artista: "John Lennon", duracion: 183 });
...
// Escribe tu código aquí
const playlistTitulos = playlist.map(cancion => cancion.titulo);
...
// Escribe tu código aquí
const playlistLargas = playlist.filter(cancion => cancion.duracion > 400);
...
// Escribe tu código aquí
const cancionEagles = playlist.find(cancion => cancion.artista == "Eagles");
