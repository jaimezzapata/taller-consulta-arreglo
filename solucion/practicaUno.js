...
playlistInicial.shift();  // Elimina la primera canción del arreglo
console.log(playlistInicial);
...
const playlistTitulos = playlistInicial.map(cancion => cancion.titulo);  // Devuelve un nuevo arreglo con los títulos
...
const playlistLargas = playlistInicial.filter(cancion => cancion.duracion > 400);  // Filtra las canciones de más de 400 segundos
...
const cancionEagles = playlistInicial.find(cancion => cancion.artista === "Eagles");  // Encuentra la primera canción de "Eagles"
